...
public class monDesert extends AppCompatActivity {
    ...
    private List<ItemList> getItems() {
        ...
        itemLists.add(new ItemList("Desert","Lvl: 1", "Preguntes totals: 10", R.drawable.minifire,R.drawable.staroff, R.drawable.staroff, R.drawable.staroff));
        itemLists.add(new ItemList("Desert","Lvl: 1", "Preguntes totals: 10", R.drawable.skeleton,R.drawable.staroff, R.drawable.staroff, R.drawable.staroff));
        return itemLists;
    }
